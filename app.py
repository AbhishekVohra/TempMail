...
from tkinter import messagebox, Listbox, Scrollbar, filedialog, Text, Frame, Button
import requests
import random
import string
import os
        ...
        try:
            ...
            if emails:
                for mail in emails:
                    ...
                    email_text = Text(email_frame, font=('Arial', 12), bg='#424242', fg='white', wrap=tk.WORD, height=5, state=tk.NORMAL)
